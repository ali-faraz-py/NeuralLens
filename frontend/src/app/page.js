...
export default function Home() {
  ...
  const confidenceInfo = (conf) => {
    ...
    if (conf > 0.4) return { text: "MEDIUM CONFIDENCE", color: "#00c2ff" };
  ...
  return (
    <main
      ...
      style={{
        background:
          "radial-gradient(circle at 30% 20%, rgba(0,194,255,0.08), transparent 40%), radial-gradient(circle at 80% 80%, rgba(0,229,160,0.08), transparent 40%), #f7f9fb",
      }}
    >
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
        <div className="flex items-center justify-center gap-2 mb-1">
          <span
            ...
            style={{ background: "linear-gradient(135deg, #00c2ff, #00e5a0)" }}
          >
            🔍
          </span>
        ...
        {!preview && (
          <label
            ...
            style={{ borderColor: "#c8e6ef" }}
            onMouseEnter={(e) => (e.currentTarget.style.borderColor = "#00c2ff")}
            onMouseLeave={(e) => (e.currentTarget.style.borderColor = "#c8e6ef")}
          >
        ...
        {preview && (
          <div
            className="relative mt-1 bg-black rounded-xl p-3 overflow-hidden"
            style={{ boxShadow: "0 0 0 1px rgba(0,194,255,0.25), 0 8px 30px -8px rgba(0,229,160,0.35)" }}
          >
            <span className="absolute top-2 left-2 w-6 h-6 border-t-[3px] border-l-[3px] rounded-tl-sm" style={{ borderColor: "#00c2ff" }} />
            ...
            <span className="absolute bottom-2 right-2 w-6 h-6 border-b-[3px] border-r-[3px] rounded-br-sm" style={{ borderColor: "#00c2ff" }} />
        ...
        <button
          ...
          className="mt-6 w-full py-3 text-white font-medium rounded-xl disabled:opacity-40 disabled:cursor-not-allowed transition cursor-pointer hover:opacity-90"
